    ...
    <div class="filters-content">
      <div class="row grid  wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div class="col-sm-6 col-lg-4 all pizza wow fadeInUp" data-wow-delay="0.1s">
          <a class="whatsapp-redirect" target="blank" data-menu="RiceBowl Chicken Katsu">
            <div class="box">
              <div>
                <div class="img-box">
        ...
        <div class="col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
          <a class="whatsapp-redirect" target="blank" data-menu="RiceBowl Paru Balado">
            <div class="box">
              <div>
                <div class="img-box">
        ...
        <div class="col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
          <a class="whatsapp-redirect" target="blank" data-menu="Tumpeng Andong">
            <div class="box">
              <div>
                <div class="img-box">
        ...
        <div class="col-sm-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
          <a class="whatsapp-redirect" target="blank" data-menu="RiceBowl Chicken Katsu TarTar Sauce">
            <div class="box">
              <div>
                <div class="img-box">
...
<!-- 16:9 aspect ratio  ini Komentar -->
